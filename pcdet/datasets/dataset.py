...
class DatasetTemplate(torch_data.Dataset):
    ...
    def prepare_data(self, data_dict, no_aug=False, no_regen=False):
        """
        Args:
            data_dict:
        ...
        Returns:
            data_dict:
                ...
                ...
        """
        if self.training and not no_aug:
        ...
        if not no_regen and self.training and len(data_dict['gt_boxes']) == 0:
