...
from pcdet.utils import common_utils, commu_utils, pseudo_label_sampler
...
def train_model(model, optimizer, train_loader, model_func, lr_scheduler, optim_cfg,
                start_epoch, total_epochs, start_iter, rank, tb_log, ckpt_save_dir, train_sampler=None, pl_sampler=None,
    ...
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True, leave=(rank == 0)) as tbar:
        ...
        for cur_epoch in tbar:
            ...
            if pl_sampler is not None and cur_epoch % pl_sampler.interval == 0:
                pl_sampler.sample_pseudo_labels()
                train_loader.dataset.data_augmentor.update_gt_sampling()
